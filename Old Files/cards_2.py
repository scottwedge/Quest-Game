...
# Green Knight
im_gk = Image.open(image_path+r"\gk.jpg")
...
# Dragon
im_drg = Image.open(image_path+r"\dragon.jpg")
dragon = foe("Dragon", im_drg, 70, "Beware")
#dragon.image.show()


# Allies
im_sl = Image.open(image_path+r"\lance.jpg")
sr_lance = ally("Sir Lancelot", im_sl, 20, "He lances, alot.")
#sr_lance.image.show()


# Equipment
im_sw = Image.open(image_path+r"\sword.png")
sword = equipment("Sword", im_sw, "weapon", 10, "1 hand")

im_helm = Image.open(image_path+r"\helmet.jpg")
helmet = equipment("Helment", im_helm, "armor", 5, "head")

im_hor = Image.open(image_path+r"\horse.jpg")
